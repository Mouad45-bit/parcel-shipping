...
export function BackOfficeNavigation({
  ...
  return (
    ...
    >
      <div className="relative flex min-w-max items-center rounded-2xl border border-secondary bg-secondary/30 p-1.5 shadow-sm">
        {indicatorIndex >= 0 ? (
          <span
            aria-hidden="true"
            ...
            >
              ...
              {!isLastItem ? (
                <span
                  aria-hidden="true"
                  className={[
                    "pointer-events-none absolute right-0 top-1/2 h-4 w-0.5 -translate-y-1/2 translate-x-1/2 rounded-full bg-primary/35 transition-opacity duration-200",
